...
<html lang="en">
    ...
    <body>
        ...
        <!--/ Banner-->
        <div class="box">
			<h1>Welcome, <?php echo $_SESSION["comName"]?>! </h1>
		    <input class="button" type="submit" name="e" value="Edit Profile" onClick="document.location.href='com_update.php'" >
		    <input class="button" type="submit" name="a" value="Applicants" onClick="document.location.href='com_applications.php'" >
		    <input class="button" type="submit" name="d" value="Delete user" onClick="document.location.href='com_delete.php'" >
		    <input class="button" type="submit" name="l" value="Logout" onClick="document.location.href='com_logout.php'" >
        </div>
    </body>
</html>