...
<!DOCTYPE html>
    ...
    <body>
        ...
        <hr>
        <input type="button" value="Edit Profile" class="homebutton" id="u" onClick="document.location.href='com_update.php'" />
        <input type="button" value="Applicants" class="homebutton" id="u" onClick="document.location.href='com_applications.php'" />
